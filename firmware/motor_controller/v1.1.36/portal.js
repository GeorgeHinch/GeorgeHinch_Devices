const PREVIEW_DEFAULTS = {
  deviceId: 'MOTORCON_123456789ABC', ip: '192.168.4.1', firmware: '1.1.35', connected: true,
  ...
  mqttUser: 'layout-controller', jmriChannel: '/trains/', motorLedAssignments: [0, 0], otaState: 'Up to date (v1.1.35)'
};
