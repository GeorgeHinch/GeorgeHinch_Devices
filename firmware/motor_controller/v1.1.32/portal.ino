...
void handleConfigJson() {
  ...
  for (uint8_t i = 0; i < MOTOR_COUNT; ++i) {
    ...
    motor["arcActive"] = motors[i].activeEndpointIsEnd ? "end" : "start";
...
void handleConfigSave() {
  ...
  motors[0].activeEndpointIsEnd = configServer.arg("arcActive1") != "start";
  if (settings.linkMotorGroups) {
    ...
    motors[1].activeEndpointIsEnd = configServer.arg("arcActive2") != "start";
  }
