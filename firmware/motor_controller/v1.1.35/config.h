...
constexpr uint16_t DEFAULT_BEG_BUTTON_RUN_SECONDS = 20;
...
constexpr uint16_t DEFAULT_SENSOR_RUN_SECONDS = 20;
...
constexpr uint16_t DEFAULT_SENSOR_CLEAR_HOLD_MS = 1000;
