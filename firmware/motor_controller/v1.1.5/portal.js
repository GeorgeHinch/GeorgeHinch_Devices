...
function updateSensorUi(config) {
  ...
  const modeDisabled = document.querySelector('#sensormode').value === '0';
  document.querySelector('#sensortarget').disabled = modeDisabled;
  document.querySelector('#sensortime').disabled = modeDisabled;
...
function populate(config) {
  ...
  setValue('sensormode', config.sensorMode); setValue('sensortarget', config.sensorTarget); setValue('sensortime', config.sensorTime);
