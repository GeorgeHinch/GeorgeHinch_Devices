...
void handleConfigSave() {
  ...
  settings.begButtonAction = static_cast<BegButtonAction>(boundedFormNumber(
      "begaction", DEFAULT_BEG_BUTTON_ACTION, BEG_BUTTON_DISABLED, BEG_BUTTON_GROUP_2));
  if (settings.begButtonAction != BEG_BUTTON_DISABLED) {
    settings.begButtonRunIndefinitely = configServer.hasArg("begindef");
