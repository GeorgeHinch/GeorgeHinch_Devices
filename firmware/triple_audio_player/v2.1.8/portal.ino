...
void sendConfigJson() {
  ...
  doc["begButtonRunSeconds"] = settings.begButtonRunSeconds;
...
void savePortalSettings() {
  ...
  settings.begButtonAction = configServer.hasArg("begButtonEnabled")
      ...
      : BEG_DISABLED;
  settings.begButtonRunSeconds = boundedArgument(
      "begButtonRunSeconds", settings.begButtonRunSeconds, 1, 3600);
