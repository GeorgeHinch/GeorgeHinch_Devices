...
#define FIRMWARE_VERSION "2.1.22"
...
void appendStationConfiguration(JsonDocument& doc) {
  ...
  for (int index = 0; index < 3; ++index) {
    ...
    addModeOptions(mode);
    JsonObject volume = addField(player, prefix + "Volume", "Volume", "number");
  ...
  JsonObject buttonVolume = addField(button, "externalButtonVolume", "Button volume", "number");
