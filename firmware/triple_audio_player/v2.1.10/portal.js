const PREVIEW_DEFAULTS = {
  ...
  globalBegEnabled: true, begButtonEnabled: true, begAction: 1, begButtonRunSeconds: 20,
  players: [
...
function updateExternalButtonUi() {
  ...
  document.querySelector('#begButtonRunSeconds').disabled = !enabled;
}
...
function populate(config) {
  ...
  setValue('begButtonRunSeconds', config.begButtonRunSeconds || 20);
