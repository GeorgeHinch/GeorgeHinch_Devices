const PREVIEW_DEFAULTS = {
  deviceId: 'AUDIOPLAY_123456789ABC', ip: '192.168.4.1', firmware: '2.1.19', connected: true,
  ...
  mqttUser: 'layout-controller', jmriChannel: '/trains/', otaState: 'Up to date (v2.1.19)'
};
